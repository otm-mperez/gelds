<?php include "components/header.php"; ?>
    <main>
      ...
      <h2 class="alt-title">Typography</h2>
      <hr>
      <h1 class="title">H1 Title</h1>
      <h2 class="alt-title">H2 Alt Title</h2>
      <h3 class="subtitle">H3 Subtitle</h3>
      <h4 class="section-title">H4 Section Title</h4>
      <h5 class="subsection-title">H5 Subsection Title</h5>
      <h6 class="para-title">H6 Para Title</h6>


      <br><br>
      <h2 class="alt-title">Components</h2>
      <hr>
      ...
      <h2 class="alt-title">Components in Progress</h2>
        ...
        <!-- <ul class="nav nav-tabs">
          ...
          <li class="nav-item">
            <a class="nav-link disabled" aria-current="page" href="#">Three</a>
          </li>
      </ul> -->
